...
public class Main {
  ...
  public Main(String[] args) {
    ...
    // If the number of command line parameters is not 1 then issue warning and 
    // exit, else if values are read in correctly from the configuration file 
   ...
   * @param in the buffered input stream for the config file
   * @throws java.lang.Exception a line cannot be read
